  ...
  return (
    <section className="container pt-16 pb-24 md:pt-24 md:pb-32">
      <div className="space-y-8">
        ...
        <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl xl:text-8xl leading-[1.05] text-foreground">
          Um espaço para <em className="text-primary not-italic">sentir</em>,
          <br /> pensar e habitar-se.
        </h1>
        <div className="space-y-5">
          <p className="max-w-5xl text-xl md:text-2xl text-muted-foreground leading-relaxed">
